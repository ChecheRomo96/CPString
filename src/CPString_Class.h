	...
	namespace CrossPlatformString
	{
		class string
		{
				...
				// Copy Constructor and assignment operator
					...
					// int
						...
						// unsigned int
							...
							string(const uint8_t Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
							string(const uint8_t Source, const char* format, unsigned int Size);
							string& operator=(const uint8_t Source);

							string(const uint16_t Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
							string(const uint16_t Source, const char* format, unsigned int Size);
							string& operator=(const uint16_t Source);

							string(const uint32_t Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
							string(const uint32_t Source, const char* format, unsigned int Size);
							string& operator=(const uint32_t Source);

							string(const uint64_t Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
			...
			private:
				...
				void _BaseConversion_uint8 (const uint8_t  Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
				void _BaseConversion_uint16(const uint16_t Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
				void _BaseConversion_uint32(const uint32_t Source, uint8_t Base = 10, bool LetterCase = CPString::LetterConversion::LetterCase::Mode);
